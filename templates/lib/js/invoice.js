...
function newRowTable()
{
    ...
    cell1.innerHTML = '<p name="codigo_p[]" class="non-margin">'+codigo+'</p>';
    ...
    cell5.innerHTML = '<p name="subtotal_p[]" class="non-margin">'+subtotal+'</p>';
    cell6.innerHTML = '<span class="icon fa-edit"></span><span class="icon fa-eraser"></span>';
